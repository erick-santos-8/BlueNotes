...
const EditAndCreateNote = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-2 p-4 bg-gray-100 dark:bg-gray-900 rounded-lg drop-shadow-lg shadow-md'>
      ...
      <div className='flex flex-col justify-center items-start gap-2 w-full'>
        ...
        <input type="text" id="tags" className='input-box w-full text-xs outline-none' placeholder='React JavaScript Node.js' />
      </div>
